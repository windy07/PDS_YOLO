...
namespace eval ::optrace {
  variable script "D:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.runs/finn_design_StreamingDataWidthConverter_hls_0_0_synth_1/finn_design_StreamingDataWidthConverter_hls_0_0.tcl"
...
OPTRACE "finn_design_StreamingDataWidthConverter_hls_0_0_synth_1" START { ROLLUP_AUTO }
...
read_ip -quiet D:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/ip/finn_design_StreamingDataWidthConverter_hls_0_0/finn_design_StreamingDataWidthConverter_hls_0_0.xci
...
set cacheID [config_ip_cache -export -no_bom  -dir D:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.runs/finn_design_StreamingDataWidthConverter_hls_0_0_synth_1 -new_name finn_design_StreamingDataWidthConverter_hls_0_0 -ip [get_ips finn_design_StreamingDataWidthConverter_hls_0_0]]
...
synth_design -top finn_design_StreamingDataWidthConverter_hls_0_0 -part xc7z020clg400-1 -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix finn_design_StreamingDataWidthConverter_hls_0_0_ finn_design_StreamingDataWidthConverter_hls_0_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ finn_design_StreamingDataWidthConverter_hls_0_0_stub.v
 lappend ipCachedFiles finn_design_StreamingDataWidthConverter_hls_0_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ finn_design_StreamingDataWidthConverter_hls_0_0_stub.vhdl
 lappend ipCachedFiles finn_design_StreamingDataWidthConverter_hls_0_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ finn_design_StreamingDataWidthConverter_hls_0_0_sim_netlist.v
 lappend ipCachedFiles finn_design_StreamingDataWidthConverter_hls_0_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ finn_design_StreamingDataWidthConverter_hls_0_0_sim_netlist.vhdl
 lappend ipCachedFiles finn_design_StreamingDataWidthConverter_hls_0_0_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp finn_design_StreamingDataWidthConverter_hls_0_0.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips finn_design_StreamingDataWidthConverter_hls_0_0]
 }
...
rename_ref -prefix_all finn_design_StreamingDataWidthConverter_hls_0_0_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef finn_design_StreamingDataWidthConverter_hls_0_0.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "finn_design_StreamingDataWidthConverter_hls_0_0_synth_1_synth_report_utilization_0" "report_utilization -file finn_design_StreamingDataWidthConverter_hls_0_0_utilization_synth.rpt -pb finn_design_StreamingDataWidthConverter_hls_0_0_utilization_synth.pb"
OPTRACE "synth reports" END { }

if { [catch {
  file copy -force D:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.runs/finn_design_StreamingDataWidthConverter_hls_0_0_synth_1/finn_design_StreamingDataWidthConverter_hls_0_0.dcp d:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_StreamingDataWidthConverter_hls_0_0/finn_design_StreamingDataWidthConverter_hls_0_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub d:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_StreamingDataWidthConverter_hls_0_0/finn_design_StreamingDataWidthConverter_hls_0_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub d:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_StreamingDataWidthConverter_hls_0_0/finn_design_StreamingDataWidthConverter_hls_0_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim d:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_StreamingDataWidthConverter_hls_0_0/finn_design_StreamingDataWidthConverter_hls_0_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim d:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_StreamingDataWidthConverter_hls_0_0/finn_design_StreamingDataWidthConverter_hls_0_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force D:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.runs/finn_design_StreamingDataWidthConverter_hls_0_0_synth_1/finn_design_StreamingDataWidthConverter_hls_0_0_stub.v d:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_StreamingDataWidthConverter_hls_0_0/finn_design_StreamingDataWidthConverter_hls_0_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}
...
if { [catch {
  file rename -force D:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.runs/finn_design_StreamingDataWidthConverter_hls_0_0_synth_1/finn_design_StreamingDataWidthConverter_hls_0_0_sim_netlist.v d:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_StreamingDataWidthConverter_hls_0_0/finn_design_StreamingDataWidthConverter_hls_0_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.runs/finn_design_StreamingDataWidthConverter_hls_0_0_synth_1/finn_design_StreamingDataWidthConverter_hls_0_0_sim_netlist.vhdl d:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_StreamingDataWidthConverter_hls_0_0/finn_design_StreamingDataWidthConverter_hls_0_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir D:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.ip_user_files/ip/finn_design_StreamingDataWidthConverter_hls_0_0]} {
  catch { 
    file copy -force d:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_StreamingDataWidthConverter_hls_0_0/finn_design_StreamingDataWidthConverter_hls_0_0_stub.v D:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.ip_user_files/ip/finn_design_StreamingDataWidthConverter_hls_0_0
  }
}

if {[file isdir D:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.ip_user_files/ip/finn_design_StreamingDataWidthConverter_hls_0_0]} {
  catch { 
    file copy -force d:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_StreamingDataWidthConverter_hls_0_0/finn_design_StreamingDataWidthConverter_hls_0_0_stub.vhdl D:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.ip_user_files/ip/finn_design_StreamingDataWidthConverter_hls_0_0
  }
}
file delete __synthesis_is_running__
close [open __synthesis_is_complete__ w]
OPTRACE "finn_design_StreamingDataWidthConverter_hls_0_0_synth_1" END { }
