...
HD_PWD='D:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.runs/finn_design_fifo_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log finn_design_fifo_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source finn_design_fifo_8.tcl
