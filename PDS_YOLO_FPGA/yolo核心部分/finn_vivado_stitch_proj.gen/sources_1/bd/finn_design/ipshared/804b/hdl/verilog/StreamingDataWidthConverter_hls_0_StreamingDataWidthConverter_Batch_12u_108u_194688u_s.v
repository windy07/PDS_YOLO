...
module StreamingDataWidthConverter_hls_0_StreamingDataWidthConverter_Batch_12u_108u_194688u_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_ready;
input   in0_V_TVALID;
output  [107:0] intermediate1_din;
...
reg   [11:0] ei_V_reg_208;
wire   [0:0] icmp_ln566_fu_124_p2;
reg   [95:0] p_Val2_s_fu_56;
wire   [95:0] trunc_ln_fu_169_p3;
wire    ap_loop_init;
reg    ap_loop_init_pp0_iter1_reg;
reg   [95:0] ap_sig_allocacmp_p_Val2_load;
reg   [95:0] ap_sig_allocacmp_p_Val2_load_1;
reg   [31:0] i_fu_60;
...
always @ (*) begin
    if (((1'b1 == ap_CS_iter1_fsm_state2) & (ap_loop_init_pp0_iter1_reg == 1'b1))) begin
        ap_sig_allocacmp_p_Val2_load = 96'd0;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_iter1_fsm_state2) & (ap_loop_init_pp0_iter1_reg == 1'b1))) begin
        ap_sig_allocacmp_p_Val2_load_1 = 96'd0;
    end else begin
...
assign ei_V_fu_114_p1 = in0_V_TDATA_int_regslice[11:0];
...
assign tmp_fu_159_p4 = {{ap_sig_allocacmp_p_Val2_load_1[95:12]}};

assign trunc_ln_fu_169_p3 = {{ei_V_reg_208}, {tmp_fu_159_p4}};

endmodule //StreamingDataWidthConverter_hls_0_StreamingDataWidthConverter_Batch_12u_108u_194688u_s
