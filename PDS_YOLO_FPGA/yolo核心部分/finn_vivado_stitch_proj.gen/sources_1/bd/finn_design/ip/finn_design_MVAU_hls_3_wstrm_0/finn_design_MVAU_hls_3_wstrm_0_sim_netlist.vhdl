...
--               d:/finn_dev_root/vivado_stitch_proj_wlkx21xb/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_MVAU_hls_3_wstrm_0/finn_design_MVAU_hls_3_wstrm_0_sim_netlist.vhdl
...
architecture STRUCTURE of finn_design_MVAU_hls_3_wstrm_0_axi4lite_if is
  ...
  signal \ip_addr[8]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \ip_addr[8]_i_3\ : label is "soft_lutpair0";
begin
...
\ip_addr[8]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFDFDFD"
    )
        port map (
...
architecture STRUCTURE of finn_design_MVAU_hls_3_wstrm_0_memstream is
  ...
  signal \blkStage1.Ptr[0][lst]_i_9_n_0\ : STD_LOGIC;
  ...
  signal \blkStage1.Ptr[0][val][7]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \blkStage1.Ptr[1][val][8]_i_2\ : label is "soft_lutpair5";
  ...
  attribute ram_addr_end of \blkStage2.Mem_reg_0\ : label is 447;
  ...
  attribute ram_addr_end of \blkStage2.Mem_reg_1\ : label is 447;
  ...
  attribute ram_addr_end of \blkStage2.Mem_reg_2\ : label is 447;
  ...
  attribute ram_addr_end of \blkStage2.Mem_reg_3\ : label is 447;
...
\blkStage1.Ptr[0][lst]_i_9\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"515151555D5D5D55"
    )
        port map (
...
config_if: entity work.finn_design_MVAU_hls_3_wstrm_0_axi4lite_if
     port map (
      ...
      E(0) => mem_n_2,
      Q(8 downto 0) => ip_addr(8 downto 0),
      ap_clk => ap_clk,
      ap_rst_n => ap_rst_n,
