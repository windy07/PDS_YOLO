...
set C_modelArgList {
	{ buf_V int 3 regular {array 208 { 2 3 } 1 1 }  }
	{ buf_V_1 int 3 regular {array 208 { 2 3 } 1 1 }  }
	{ buf_V_2 int 3 regular {array 208 { 2 3 } 1 1 }  }
	{ buf_V_3 int 3 regular {array 208 { 2 3 } 1 1 }  }
	{ buf_V_4 int 3 regular {array 208 { 2 3 } 1 1 }  }
	{ buf_V_5 int 3 regular {array 208 { 2 3 } 1 1 }  }
	{ buf_V_6 int 3 regular {array 208 { 2 3 } 1 1 }  }
	{ buf_V_7 int 3 regular {array 208 { 2 3 } 1 1 }  }
...
set Spec2ImplPortList { 
	buf_V { ap_memory {  { buf_V_address0 mem_address 1 8 }  { buf_V_ce0 mem_ce 1 1 }  { buf_V_we0 mem_we 1 1 }  { buf_V_d0 mem_din 1 3 }  { buf_V_q0 in_data 0 3 } } }
	buf_V_1 { ap_memory {  { buf_V_1_address0 mem_address 1 8 }  { buf_V_1_ce0 mem_ce 1 1 }  { buf_V_1_we0 mem_we 1 1 }  { buf_V_1_d0 mem_din 1 3 }  { buf_V_1_q0 in_data 0 3 } } }
	buf_V_2 { ap_memory {  { buf_V_2_address0 mem_address 1 8 }  { buf_V_2_ce0 mem_ce 1 1 }  { buf_V_2_we0 mem_we 1 1 }  { buf_V_2_d0 mem_din 1 3 }  { buf_V_2_q0 in_data 0 3 } } }
	buf_V_3 { ap_memory {  { buf_V_3_address0 mem_address 1 8 }  { buf_V_3_ce0 mem_ce 1 1 }  { buf_V_3_we0 mem_we 1 1 }  { buf_V_3_d0 mem_din 1 3 }  { buf_V_3_q0 in_data 0 3 } } }
	buf_V_4 { ap_memory {  { buf_V_4_address0 mem_address 1 8 }  { buf_V_4_ce0 mem_ce 1 1 }  { buf_V_4_we0 mem_we 1 1 }  { buf_V_4_d0 mem_din 1 3 }  { buf_V_4_q0 in_data 0 3 } } }
	buf_V_5 { ap_memory {  { buf_V_5_address0 mem_address 1 8 }  { buf_V_5_ce0 mem_ce 1 1 }  { buf_V_5_we0 mem_we 1 1 }  { buf_V_5_d0 mem_din 1 3 }  { buf_V_5_q0 in_data 0 3 } } }
	buf_V_6 { ap_memory {  { buf_V_6_address0 mem_address 1 8 }  { buf_V_6_ce0 mem_ce 1 1 }  { buf_V_6_we0 mem_we 1 1 }  { buf_V_6_d0 mem_din 1 3 }  { buf_V_6_q0 in_data 0 3 } } }
	buf_V_7 { ap_memory {  { buf_V_7_address0 mem_address 1 8 }  { buf_V_7_ce0 mem_ce 1 1 }  { buf_V_7_we0 mem_we 1 1 }  { buf_V_7_d0 mem_din 1 3 }  { buf_V_7_q0 in_data 0 3 } } }
