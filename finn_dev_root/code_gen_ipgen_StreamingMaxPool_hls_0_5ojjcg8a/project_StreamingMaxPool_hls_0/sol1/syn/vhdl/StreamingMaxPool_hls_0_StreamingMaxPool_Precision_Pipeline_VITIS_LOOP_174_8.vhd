...
attribute shreg_extract : string;
    ...
    signal outpix_fu_58 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln174_fu_195_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_outpix_1 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    add_ln174_fu_195_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_outpix_1) + unsigned(ap_const_lv8_1));
    ...
    begin
        if (((ap_const_logic_1 = ap_CS_iter0_fsm_state1) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_outpix_1 <= ap_const_lv8_0;
        else 
            ap_sig_allocacmp_outpix_1 <= outpix_fu_58;
        end if; 
    end process;

    buf_V_1_address0 <= outpix_cast_fu_201_p1(8 - 1 downto 0);
    ...
    buf_V_2_address0 <= outpix_cast_fu_201_p1(8 - 1 downto 0);
    ...
    buf_V_3_address0 <= outpix_cast_fu_201_p1(8 - 1 downto 0);
    ...
    buf_V_4_address0 <= outpix_cast_fu_201_p1(8 - 1 downto 0);
    ...
    buf_V_5_address0 <= outpix_cast_fu_201_p1(8 - 1 downto 0);
    ...
    buf_V_6_address0 <= outpix_cast_fu_201_p1(8 - 1 downto 0);
    ...
    buf_V_7_address0 <= outpix_cast_fu_201_p1(8 - 1 downto 0);
    ...
    buf_V_address0 <= outpix_cast_fu_201_p1(8 - 1 downto 0);
    ...
    icmp_ln174_fu_189_p2 <= "1" when (ap_sig_allocacmp_outpix_1 = ap_const_lv8_D0) else "0";
