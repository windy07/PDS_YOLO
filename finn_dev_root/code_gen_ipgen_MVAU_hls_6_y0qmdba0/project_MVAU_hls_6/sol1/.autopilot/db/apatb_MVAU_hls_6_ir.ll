; ModuleID = '/tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_6_y0qmdba0/project_MVAU_hls_6/sol1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_MVAU_hls_6_ir(%"class.hls::stream<ap_uint<24>, 0>"* noalias nocapture nonnull dereferenceable(4) %in0_V, %"class.hls::stream<ap_uint<64>, 0>"* noalias nocapture nonnull dereferenceable(8) %weights_V, %"class.hls::stream<ap_uint<3>, 0>"* noalias nocapture nonnull dereferenceable(1) %out_V) local_unnamed_addr #1 {
entry:
  ...
  %weights_V_copy = alloca %"class.hls::stream<ap_uint<64>, 0>", align 512
  call void @llvm.sideeffect() #8 [ "stream_interface"(%"class.hls::stream<ap_uint<64>, 0>"* %weights_V_copy, i32 0) ]
  %out_V_copy = alloca %"class.hls::stream<ap_uint<3>, 0>", align 512
  call void @llvm.sideeffect() #9 [ "stream_interface"(%"class.hls::stream<ap_uint<3>, 0>"* %out_V_copy, i32 0) ]
  call fastcc void @copy_in(%"class.hls::stream<ap_uint<24>, 0>"* nonnull %in0_V, %"class.hls::stream<ap_uint<24>, 0>"* nonnull align 512 %in0_V_copy, %"class.hls::stream<ap_uint<64>, 0>"* nonnull %weights_V, %"class.hls::stream<ap_uint<64>, 0>"* nonnull align 512 %weights_V_copy, %"class.hls::stream<ap_uint<3>, 0>"* nonnull %out_V, %"class.hls::stream<ap_uint<3>, 0>"* nonnull align 512 %out_V_copy)
  call void @apatb_MVAU_hls_6_hw(%"class.hls::stream<ap_uint<24>, 0>"* %in0_V_copy, %"class.hls::stream<ap_uint<64>, 0>"* %weights_V_copy, %"class.hls::stream<ap_uint<3>, 0>"* %out_V_copy)
  call void @copy_back(%"class.hls::stream<ap_uint<24>, 0>"* %in0_V, %"class.hls::stream<ap_uint<24>, 0>"* %in0_V_copy, %"class.hls::stream<ap_uint<64>, 0>"* %weights_V, %"class.hls::stream<ap_uint<64>, 0>"* %weights_V_copy, %"class.hls::stream<ap_uint<3>, 0>"* %out_V, %"class.hls::stream<ap_uint<3>, 0>"* %out_V_copy)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(%"class.hls::stream<ap_uint<24>, 0>"* noalias, %"class.hls::stream<ap_uint<24>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<ap_uint<64>, 0>"* noalias, %"class.hls::stream<ap_uint<64>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<ap_uint<3>, 0>"* noalias, %"class.hls::stream<ap_uint<3>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #2 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<64>, 0>"(%"class.hls::stream<ap_uint<64>, 0>"* align 512 %3, %"class.hls::stream<ap_uint<64>, 0>"* %2)
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(%"class.hls::stream<ap_uint<24>, 0>"* noalias, %"class.hls::stream<ap_uint<24>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<ap_uint<64>, 0>"* noalias, %"class.hls::stream<ap_uint<64>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<ap_uint<3>, 0>"* noalias, %"class.hls::stream<ap_uint<3>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<64>, 0>"(%"class.hls::stream<ap_uint<64>, 0>"* %2, %"class.hls::stream<ap_uint<64>, 0>"* align 512 %3)
...
declare void @apatb_MVAU_hls_6_hw(%"class.hls::stream<ap_uint<24>, 0>"*, %"class.hls::stream<ap_uint<64>, 0>"*, %"class.hls::stream<ap_uint<3>, 0>"*)

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_back(%"class.hls::stream<ap_uint<24>, 0>"* noalias, %"class.hls::stream<ap_uint<24>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<ap_uint<64>, 0>"* noalias, %"class.hls::stream<ap_uint<64>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<ap_uint<3>, 0>"* noalias, %"class.hls::stream<ap_uint<3>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<24>, 0>"(%"class.hls::stream<ap_uint<24>, 0>"* %0, %"class.hls::stream<ap_uint<24>, 0>"* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<64>, 0>"(%"class.hls::stream<ap_uint<64>, 0>"* %2, %"class.hls::stream<ap_uint<64>, 0>"* align 512 %3)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<3>, 0>"(%"class.hls::stream<ap_uint<3>, 0>"* %4, %"class.hls::stream<ap_uint<3>, 0>"* align 512 %5)
...
define void @MVAU_hls_6_hw_stub_wrapper(%"class.hls::stream<ap_uint<24>, 0>"*, %"class.hls::stream<ap_uint<64>, 0>"*, %"class.hls::stream<ap_uint<3>, 0>"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream<ap_uint<24>, 0>"* null, %"class.hls::stream<ap_uint<24>, 0>"* %0, %"class.hls::stream<ap_uint<64>, 0>"* null, %"class.hls::stream<ap_uint<64>, 0>"* %1, %"class.hls::stream<ap_uint<3>, 0>"* null, %"class.hls::stream<ap_uint<3>, 0>"* %2)
  call void @MVAU_hls_6_hw_stub(%"class.hls::stream<ap_uint<24>, 0>"* %0, %"class.hls::stream<ap_uint<64>, 0>"* %1, %"class.hls::stream<ap_uint<3>, 0>"* %2)
  call void @copy_in(%"class.hls::stream<ap_uint<24>, 0>"* null, %"class.hls::stream<ap_uint<24>, 0>"* %0, %"class.hls::stream<ap_uint<64>, 0>"* null, %"class.hls::stream<ap_uint<64>, 0>"* %1, %"class.hls::stream<ap_uint<3>, 0>"* null, %"class.hls::stream<ap_uint<3>, 0>"* %2)
  ret void
}

declare void @MVAU_hls_6_hw_stub(%"class.hls::stream<ap_uint<24>, 0>"*, %"class.hls::stream<ap_uint<64>, 0>"*, %"class.hls::stream<ap_uint<3>, 0>"*)
