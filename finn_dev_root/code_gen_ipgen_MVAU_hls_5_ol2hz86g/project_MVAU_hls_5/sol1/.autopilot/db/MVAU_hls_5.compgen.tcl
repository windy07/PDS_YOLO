...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { weights_V_TDATA { I 936 vector } weights_V_TVALID { I 1 bit } weights_V_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_V_TDATA { O 40 vector } out_V_TVALID { O 1 bit } out_V_TREADY { I 1 bit } } \
} "
} else {
...
# RegSlice definition:
set ID 221
set RegSliceName MVAU_hls_5_regslice_both
set RegSliceInstName MVAU_hls_5_regslice_both_U
set CoreName ap_simcore_MVAU_hls_5_regslice_both
