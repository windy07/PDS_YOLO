; ModuleID = '/tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_1_r23awlkq/project_MVAU_hls_1/sol1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_MVAU_hls_1_ir(%"class.hls::stream<ap_uint<27>, 0>"* noalias nocapture nonnull dereferenceable(4) %in0_V, %"class.hls::stream<ap_uint<576>, 0>"* noalias nocapture nonnull dereferenceable(128) %weights_V, %"class.hls::stream<ap_uint<24>, 0>"* noalias nocapture nonnull dereferenceable(4) %out_V) local_unnamed_addr #1 {
entry:
  ...
  call void @apatb_MVAU_hls_1_hw(%"class.hls::stream<ap_uint<27>, 0>"* %in0_V_copy, %"class.hls::stream<ap_uint<576>, 0>"* %weights_V_copy, %"class.hls::stream<ap_uint<24>, 0>"* %out_V_copy)
...
declare void @apatb_MVAU_hls_1_hw(%"class.hls::stream<ap_uint<27>, 0>"*, %"class.hls::stream<ap_uint<576>, 0>"*, %"class.hls::stream<ap_uint<24>, 0>"*)
...
define void @MVAU_hls_1_hw_stub_wrapper(%"class.hls::stream<ap_uint<27>, 0>"*, %"class.hls::stream<ap_uint<576>, 0>"*, %"class.hls::stream<ap_uint<24>, 0>"*) #6 {
entry:
  ...
  call void @MVAU_hls_1_hw_stub(%"class.hls::stream<ap_uint<27>, 0>"* %0, %"class.hls::stream<ap_uint<576>, 0>"* %1, %"class.hls::stream<ap_uint<24>, 0>"* %2)
...
declare void @MVAU_hls_1_hw_stub(%"class.hls::stream<ap_uint<27>, 0>"*, %"class.hls::stream<ap_uint<576>, 0>"*, %"class.hls::stream<ap_uint<24>, 0>"*)
