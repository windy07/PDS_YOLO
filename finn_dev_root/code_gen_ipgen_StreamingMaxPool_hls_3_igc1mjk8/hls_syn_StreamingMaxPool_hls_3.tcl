...
set config_proj_name project_StreamingMaxPool_hls_3
puts "HLS project: $config_proj_name"
set config_hwsrcdir "/tmp/finn_dev_root/code_gen_ipgen_StreamingMaxPool_hls_3_igc1mjk8"
...
set config_toplevelfxn "StreamingMaxPool_hls_3"
set config_clkperiod 10.0

open_project $config_proj_name
add_files $config_hwsrcdir/top_StreamingMaxPool_hls_3.cpp -cflags "-std=c++14 -I$config_bnnlibdir -I$config_customhlsdir"
