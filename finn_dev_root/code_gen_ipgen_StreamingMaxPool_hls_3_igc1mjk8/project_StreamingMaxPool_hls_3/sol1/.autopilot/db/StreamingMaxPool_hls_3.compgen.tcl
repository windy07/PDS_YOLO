...
# RegSlice definition:
set ID 137
set RegSliceName StreamingMaxPool_hls_3_regslice_both
set RegSliceInstName StreamingMaxPool_hls_3_regslice_both_U
set CoreName ap_simcore_StreamingMaxPool_hls_3_regslice_both
