...
module StreamingDataWidthConverter_hls_0_hls_deadlock_idx0_monitor ( // for module StreamingDataWidthConverter_hls_0_StreamingDataWidthConverter_hls_0_inst
    input wire clock,
    input wire reset,
