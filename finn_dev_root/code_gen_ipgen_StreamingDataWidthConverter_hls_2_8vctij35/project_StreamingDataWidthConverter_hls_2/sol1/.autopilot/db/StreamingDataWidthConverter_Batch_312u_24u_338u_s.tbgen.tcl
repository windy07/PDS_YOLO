set moduleName StreamingDataWidthConverter_Batch_312u_24u_338u_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {StreamingDataWidthConverter_Batch<312u, 24u, 338u>}
set C_modelType { void 0 }
set C_modelArgList {
	{ intermediate1 int 312 regular {fifo 0 volatile }  }
	{ out_V int 24 regular {axi_s 1 volatile  { out_V Data } }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "intermediate1", "interface" : "fifo", "bitwidth" : 312, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ intermediate1_dout sc_in sc_lv 312 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "intermediate1_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":312, "type": "signal", "bundle":{"name": "intermediate1", "role": "dout" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4397", "Max" : "4397"}
	, {"Name" : "Interval", "Min" : "4397", "Max" : "4397"}
]}
...
set Spec2ImplPortList { 
	intermediate1 { ap_fifo {  { intermediate1_dout fifo_port_we 0 312 }  { intermediate1_num_data_valid fifo_status_num_data_valid 0 2 }  { intermediate1_fifo_cap fifo_update 0 2 }  { intermediate1_empty_n fifo_status 0 1 }  { intermediate1_read fifo_data 1 1 } } }
