set moduleName StreamingDataWidthConverter_Batch_39u_312u_2704u_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {StreamingDataWidthConverter_Batch<39u, 312u, 2704u>}
set C_modelType { void 0 }
set C_modelArgList {
	{ in0_V int 40 regular {axi_s 0 volatile  { in0_V Data } }  }
	{ intermediate1 int 312 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in0_V", "interface" : "axis", "bitwidth" : 40, "direction" : "READONLY"} , 
 	{ "Name" : "intermediate1", "interface" : "fifo", "bitwidth" : 312, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ intermediate1_din sc_out sc_lv 312 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "intermediate1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":312, "type": "signal", "bundle":{"name": "intermediate1", "role": "din" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2706", "Max" : "2706"}
...
set Spec2ImplPortList { 
	in0_V { axis {  { in0_V_TVALID in_vld 0 1 }  { in0_V_TDATA in_data 0 40 }  { in0_V_TREADY in_acc 1 1 } } }
	intermediate1 { ap_fifo {  { intermediate1_din fifo_port_we 1 312 }  { intermediate1_num_data_valid fifo_status_num_data_valid 0 2 }  { intermediate1_fifo_cap fifo_update 0 2 }  { intermediate1_full_n fifo_status 0 1 }  { intermediate1_write fifo_data 1 1 } } }
}
