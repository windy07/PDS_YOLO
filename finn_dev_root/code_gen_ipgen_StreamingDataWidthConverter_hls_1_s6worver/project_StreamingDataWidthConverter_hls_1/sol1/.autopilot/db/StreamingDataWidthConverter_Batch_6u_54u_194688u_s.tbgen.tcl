set moduleName StreamingDataWidthConverter_Batch_6u_54u_194688u_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {StreamingDataWidthConverter_Batch<6u, 54u, 194688u>}
set C_modelType { void 0 }
set C_modelArgList {
	{ in0_V int 8 regular {axi_s 0 volatile  { in0_V Data } }  }
	{ intermediate1 int 54 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in0_V", "interface" : "axis", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "intermediate1", "interface" : "fifo", "bitwidth" : 54, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ intermediate1_din sc_out sc_lv 54 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "intermediate1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":54, "type": "signal", "bundle":{"name": "intermediate1", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	intermediate1 { ap_fifo {  { intermediate1_din fifo_port_we 1 54 }  { intermediate1_num_data_valid fifo_status_num_data_valid 0 2 }  { intermediate1_fifo_cap fifo_update 0 2 }  { intermediate1_full_n fifo_status 0 1 }  { intermediate1_write fifo_data 1 1 } } }
}
