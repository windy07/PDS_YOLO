...
entity StreamingDataWidthConverter_hls_1_StreamingDataWidthConverter_Batch_6u_54u_194688u_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of StreamingDataWidthConverter_hls_1_StreamingDataWidthConverter_Batch_6u_54u_194688u_s is 
...
attribute shreg_extract : string;
    ...
    signal p_Val2_s_fu_56 : STD_LOGIC_VECTOR (47 downto 0);
    signal trunc_ln_fu_169_p3 : STD_LOGIC_VECTOR (47 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_loop_init_pp0_iter1_reg : STD_LOGIC;
    signal ap_sig_allocacmp_p_Val2_load : STD_LOGIC_VECTOR (47 downto 0);
    signal ap_sig_allocacmp_p_Val2_load_1 : STD_LOGIC_VECTOR (47 downto 0);
    ...
    signal tmp_fu_159_p4 : STD_LOGIC_VECTOR (41 downto 0);
...
begin
    ...
    regslice_both_in0_V_U : component StreamingDataWidthConverter_hls_1_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_109)) then
                if ((icmp_ln557_reg_204 = ap_const_lv1_0)) then 
                    ...
                    p_Val2_s_fu_56 <= ap_const_lv48_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (((ap_const_logic_1 = ap_CS_iter1_fsm_state2) and (ap_loop_init_pp0_iter1_reg = ap_const_logic_1))) then 
            ap_sig_allocacmp_p_Val2_load <= ap_const_lv48_0;
        else 
    ...
    begin
        if (((ap_const_logic_1 = ap_CS_iter1_fsm_state2) and (ap_loop_init_pp0_iter1_reg = ap_const_logic_1))) then 
            ap_sig_allocacmp_p_Val2_load_1 <= ap_const_lv48_0;
        else 
    ...
    ei_V_fu_114_p1 <= in0_V_TDATA_int_regslice(6 - 1 downto 0);
    ...
    tmp_fu_159_p4 <= ap_sig_allocacmp_p_Val2_load_1(47 downto 6);
