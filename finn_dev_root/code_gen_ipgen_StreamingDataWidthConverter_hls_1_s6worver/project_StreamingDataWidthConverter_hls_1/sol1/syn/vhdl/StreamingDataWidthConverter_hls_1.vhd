...
entity StreamingDataWidthConverter_hls_1 is
port (
...
architecture behav of StreamingDataWidthConverter_hls_1 is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "StreamingDataWidthConverter_hls_1_StreamingDataWidthConverter_hls_1,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.591000,HLS_SYN_LAT=194692,HLS_SYN_TPT=194691,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=298,HLS_SYN_LUT=582,HLS_VERSION=2022_2}";
    constant ap_const_logic_1 : STD_LOGIC := '1';
    constant ap_const_logic_0 : STD_LOGIC := '0';

    signal ap_rst_n_inv : STD_LOGIC;
    signal StreamingDataWidthConverter_Batch_6u_54u_194688u_U0_ap_start : STD_LOGIC;
    signal StreamingDataWidthConverter_Batch_6u_54u_194688u_U0_ap_done : STD_LOGIC;
    signal StreamingDataWidthConverter_Batch_6u_54u_194688u_U0_ap_continue : STD_LOGIC;
    signal StreamingDataWidthConverter_Batch_6u_54u_194688u_U0_ap_idle : STD_LOGIC;
    signal StreamingDataWidthConverter_Batch_6u_54u_194688u_U0_ap_ready : STD_LOGIC;
    signal StreamingDataWidthConverter_Batch_6u_54u_194688u_U0_intermediate1_din : STD_LOGIC_VECTOR (53 downto 0);
    signal StreamingDataWidthConverter_Batch_6u_54u_194688u_U0_intermediate1_write : STD_LOGIC;
    signal StreamingDataWidthConverter_Batch_6u_54u_194688u_U0_in0_V_TREADY : STD_LOGIC;
    signal StreamingDataWidthConverter_Batch_54u_27u_21632u_U0_ap_start : STD_LOGIC;
    signal StreamingDataWidthConverter_Batch_54u_27u_21632u_U0_ap_done : STD_LOGIC;
    signal StreamingDataWidthConverter_Batch_54u_27u_21632u_U0_ap_continue : STD_LOGIC;
    signal StreamingDataWidthConverter_Batch_54u_27u_21632u_U0_ap_idle : STD_LOGIC;
    signal StreamingDataWidthConverter_Batch_54u_27u_21632u_U0_ap_ready : STD_LOGIC;
    signal StreamingDataWidthConverter_Batch_54u_27u_21632u_U0_intermediate1_read : STD_LOGIC;
    signal StreamingDataWidthConverter_Batch_54u_27u_21632u_U0_out_V_TDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal StreamingDataWidthConverter_Batch_54u_27u_21632u_U0_out_V_TVALID : STD_LOGIC;
    signal intermediate_full_n : STD_LOGIC;
    signal intermediate_dout : STD_LOGIC_VECTOR (53 downto 0);
    ...
    component StreamingDataWidthConverter_hls_1_StreamingDataWidthConverter_Batch_6u_54u_194688u_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ...
        in0_V_TVALID : IN STD_LOGIC;
        intermediate1_din : OUT STD_LOGIC_VECTOR (53 downto 0);
    ...
    component StreamingDataWidthConverter_hls_1_StreamingDataWidthConverter_Batch_54u_27u_21632u_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component StreamingDataWidthConverter_hls_1_fifo_w54_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
...
begin
    StreamingDataWidthConverter_Batch_6u_54u_194688u_U0 : component StreamingDataWidthConverter_hls_1_StreamingDataWidthConverter_Batch_6u_54u_194688u_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    StreamingDataWidthConverter_Batch_54u_27u_21632u_U0 : component StreamingDataWidthConverter_hls_1_StreamingDataWidthConverter_Batch_54u_27u_21632u_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    intermediate_U : component StreamingDataWidthConverter_hls_1_fifo_w54_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    StreamingDataWidthConverter_Batch_54u_27u_21632u_U0_ap_continue <= ap_const_logic_1;
    StreamingDataWidthConverter_Batch_54u_27u_21632u_U0_ap_start <= ap_const_logic_1;
    StreamingDataWidthConverter_Batch_6u_54u_194688u_U0_ap_continue <= ap_const_logic_1;
    StreamingDataWidthConverter_Batch_6u_54u_194688u_U0_ap_start <= ap_const_logic_1;
