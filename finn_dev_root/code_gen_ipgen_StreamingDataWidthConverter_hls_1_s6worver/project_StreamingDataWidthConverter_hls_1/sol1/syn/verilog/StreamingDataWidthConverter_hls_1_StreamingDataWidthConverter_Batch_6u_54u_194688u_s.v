...
module StreamingDataWidthConverter_hls_1_StreamingDataWidthConverter_Batch_6u_54u_194688u_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [5:0] ei_V_reg_208;
wire   [0:0] icmp_ln566_fu_124_p2;
reg   [47:0] p_Val2_s_fu_56;
wire   [47:0] trunc_ln_fu_169_p3;
wire    ap_loop_init;
reg    ap_loop_init_pp0_iter1_reg;
reg   [47:0] ap_sig_allocacmp_p_Val2_load;
reg   [47:0] ap_sig_allocacmp_p_Val2_load_1;
reg   [31:0] i_fu_60;
wire   [31:0] i_1_fu_118_p2;
reg   [31:0] ap_sig_allocacmp_i_load;
reg   [17:0] t_fu_64;
wire   [17:0] t_2_fu_105_p2;
...
always @ (*) begin
    if (((1'b1 == ap_CS_iter1_fsm_state2) & (ap_loop_init_pp0_iter1_reg == 1'b1))) begin
        ap_sig_allocacmp_p_Val2_load = 48'd0;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_iter1_fsm_state2) & (ap_loop_init_pp0_iter1_reg == 1'b1))) begin
        ap_sig_allocacmp_p_Val2_load_1 = 48'd0;
    end else begin
...
assign ei_V_fu_114_p1 = in0_V_TDATA_int_regslice[5:0];

assign i_1_fu_118_p2 = (ap_sig_allocacmp_i_load + 32'd1);

assign icmp_ln557_fu_99_p2 = ((ap_sig_allocacmp_t_1 == 18'd194688) ? 1'b1 : 1'b0);

assign icmp_ln557_reg_204_pp0_iter0_reg = icmp_ln557_reg_204;

assign icmp_ln566_fu_124_p2 = ((i_1_fu_118_p2 == 32'd9) ? 1'b1 : 1'b0);

assign in0_V_TREADY = regslice_both_in0_V_U_ack_in;

assign intermediate1_din = {{ei_V_reg_208}, {ap_sig_allocacmp_p_Val2_load}};

assign t_2_fu_105_p2 = (ap_sig_allocacmp_t_1 + 18'd1);

assign tmp_fu_159_p4 = {{ap_sig_allocacmp_p_Val2_load_1[47:6]}};

assign trunc_ln_fu_169_p3 = {{ei_V_reg_208}, {tmp_fu_159_p4}};

endmodule //StreamingDataWidthConverter_hls_1_StreamingDataWidthConverter_Batch_6u_54u_194688u_s
