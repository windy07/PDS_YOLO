...
# RegSlice definition:
set ID 233
set RegSliceName StreamingMaxPool_hls_4_regslice_both
set RegSliceInstName StreamingMaxPool_hls_4_regslice_both_U
set CoreName ap_simcore_StreamingMaxPool_hls_4_regslice_both
