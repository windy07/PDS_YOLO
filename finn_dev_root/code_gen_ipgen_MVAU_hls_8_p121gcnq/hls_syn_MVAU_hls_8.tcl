...
set config_proj_name project_MVAU_hls_8
puts "HLS project: $config_proj_name"
set config_hwsrcdir "/tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_8_p121gcnq"
...
set config_toplevelfxn "MVAU_hls_8"
set config_clkperiod 10.0

open_project $config_proj_name
add_files $config_hwsrcdir/top_MVAU_hls_8.cpp -cflags "-std=c++14 -I$config_bnnlibdir -I$config_customhlsdir"
