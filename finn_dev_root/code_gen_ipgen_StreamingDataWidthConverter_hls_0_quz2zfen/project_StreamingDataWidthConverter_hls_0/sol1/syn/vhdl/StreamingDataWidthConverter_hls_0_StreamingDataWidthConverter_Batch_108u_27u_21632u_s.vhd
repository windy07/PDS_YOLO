...
entity StreamingDataWidthConverter_hls_0_StreamingDataWidthConverter_Batch_108u_27u_21632u_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    intermediate1_dout : IN STD_LOGIC_VECTOR (107 downto 0);
...
architecture behav of StreamingDataWidthConverter_hls_0_StreamingDataWidthConverter_Batch_108u_27u_21632u_s is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln526_reg_209 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln529_reg_213 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln529_reg_213_pp0_iter0_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_predicate_op32_read_state2 : BOOLEAN;
    signal ap_block_state2_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_state2_io : BOOLEAN;
    signal ap_CS_iter1_fsm_state2 : STD_LOGIC;
    signal icmp_ln526_reg_209_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal ap_phi_mux_ei_V_3_phi_fu_80_p4 : STD_LOGIC_VECTOR (107 downto 0);
    signal ap_phi_reg_pp0_iter1_ei_V_3_reg_77 : STD_LOGIC_VECTOR (107 downto 0);
    signal zext_ln526_fu_159_p1 : STD_LOGIC_VECTOR (107 downto 0);
    signal ei_V_fu_52 : STD_LOGIC_VECTOR (80 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_loop_init_pp0_iter1_reg : STD_LOGIC;
    signal ap_sig_allocacmp_ei_V_load : STD_LOGIC_VECTOR (80 downto 0);
    ...
    signal t_fu_60 : STD_LOGIC_VECTOR (16 downto 0);
    signal t_4_fu_114_p2 : STD_LOGIC_VECTOR (16 downto 0);
    ...
    signal eo_V_fu_164_p1 : STD_LOGIC_VECTOR (26 downto 0);
    ...
    component StreamingDataWidthConverter_hls_0_flow_control_loop_pipe IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component StreamingDataWidthConverter_hls_0_regslice_both IS
    generic (
        DataWidth : INTEGER );
    port (
        ap_clk : IN STD_LOGIC;
...
begin
    flow_control_loop_pipe_U : component StreamingDataWidthConverter_hls_0_flow_control_loop_pipe
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => ap_start,
    ...
    regslice_both_out_V_U : component StreamingDataWidthConverter_hls_0_regslice_both
    generic map (
        DataWidth => 32)
    port map (
        ap_clk => ap_clk,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue_int = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif ((not(((regslice_both_out_V_U_apdone_blk = ap_const_logic_1) or (ap_done_reg = ap_const_logic_1) or (ap_const_boolean_1 = ap_block_state3_io) or ((icmp_ln526_reg_209_pp0_iter1_reg = ap_const_lv1_0) and (out_V_TREADY_int_regslice = ap_const_logic_0)))) and (ap_const_logic_1 = ap_CS_iter2_fsm_state3) and (ap_loop_exit_ready_pp0_iter2_reg = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((regslice_both_out_V_U_apdone_blk = ap_const_logic_1) or (ap_done_reg = ap_const_logic_1) or (ap_const_boolean_1 = ap_block_state3_io) or ((icmp_ln526_reg_209_pp0_iter1_reg = ap_const_lv1_0) and (out_V_TREADY_int_regslice = ap_const_logic_0)))) and (ap_const_logic_1 = ap_CS_iter2_fsm_state3) and (ap_loop_exit_ready_pp0_iter1_reg = ap_const_logic_0))) then 
                ap_loop_exit_ready_pp0_iter2_reg <= ap_const_logic_0;
            elsif ((not(((ap_done_reg = ap_const_logic_1) or (ap_const_boolean_1 = ap_block_state2_io) or ((ap_const_logic_1 = ap_CS_iter2_fsm_state3) and ((regslice_both_out_V_U_apdone_blk = ap_const_logic_1) or (ap_const_boolean_1 = ap_block_state3_io) or ((icmp_ln526_reg_209_pp0_iter1_reg = ap_const_lv1_0) and (out_V_TREADY_int_regslice = ap_const_logic_0)))) or ((ap_predicate_op32_read_state2 = ap_const_boolean_1) and (intermediate1_empty_n = ap_const_logic_0)) or ((icmp_ln526_reg_209 = ap_const_lv1_0) and (out_V_TREADY_int_regslice = ap_const_logic_0)))) and (ap_const_logic_1 = ap_CS_iter1_fsm_state2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_302)) then
                if ((icmp_ln526_reg_209 = ap_const_lv1_0)) then 
                    ei_V_fu_52 <= ap_phi_mux_ei_V_3_phi_fu_80_p4(107 downto 27);
                elsif ((ap_loop_init_pp0_iter1_reg = ap_const_logic_1)) then 
                    ei_V_fu_52 <= ap_const_lv81_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start_int = ap_const_logic_0) or ((ap_const_logic_1 = ap_CS_iter2_fsm_state3) and ((regslice_both_out_V_U_apdone_blk = ap_const_logic_1) or (ap_const_boolean_1 = ap_block_state3_io) or ((icmp_ln526_reg_209_pp0_iter1_reg = ap_const_lv1_0) and (out_V_TREADY_int_regslice = ap_const_logic_0)))) or ((ap_const_logic_1 = ap_CS_iter1_fsm_state2) and ((ap_const_boolean_1 = ap_block_state2_io) or ((ap_predicate_op32_read_state2 = ap_const_boolean_1) and (intermediate1_empty_n = ap_const_logic_0)) or ((icmp_ln526_reg_209 = ap_const_lv1_0) and (out_V_TREADY_int_regslice = ap_const_logic_0)))))) and (ap_const_logic_1 = ap_CS_iter0_fsm_state1))) then
    ...
    ap_NS_iter0_fsm_assign_proc : process (ap_CS_iter0_fsm, ap_done_reg, intermediate1_empty_n, icmp_ln526_reg_209, ap_predicate_op32_read_state2, ap_block_state2_io, ap_CS_iter1_fsm_state2, icmp_ln526_reg_209_pp0_iter1_reg, regslice_both_out_V_U_apdone_blk, ap_block_state3_io, ap_CS_iter2_fsm_state3, ap_start_int, out_V_TREADY_int_regslice)
    begin
    ...
    begin
        case ap_CS_iter2_fsm is
            when ap_ST_iter2_fsm_state3 => 
                ...
                elsif (((not(((regslice_both_out_V_U_apdone_blk = ap_const_logic_1) or (ap_done_reg = ap_const_logic_1) or (ap_const_boolean_1 = ap_block_state3_io) or ((icmp_ln526_reg_209_pp0_iter1_reg = ap_const_lv1_0) and (out_V_TREADY_int_regslice = ap_const_logic_0)))) and not(((ap_const_boolean_1 = ap_block_state2_io) or ((ap_predicate_op32_read_state2 = ap_const_boolean_1) and (intermediate1_empty_n = ap_const_logic_0)) or ((icmp_ln526_reg_209 = ap_const_lv1_0) and (out_V_TREADY_int_regslice = ap_const_logic_0)))) and (ap_const_logic_1 = ap_CS_iter1_fsm_state2)) or (not(((regslice_both_out_V_U_apdone_blk = ap_const_logic_1) or (ap_done_reg = ap_const_logic_1) or (ap_const_boolean_1 = ap_block_state3_io) or ((icmp_ln526_reg_209_pp0_iter1_reg = ap_const_lv1_0) and (out_V_TREADY_int_regslice = ap_const_logic_0)))) and (icmp_ln526_reg_209_pp0_iter1_reg = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_iter2_fsm_state3)))) then
    ...
    ap_ST_iter1_fsm_state2_blk_assign_proc : process(intermediate1_empty_n, icmp_ln526_reg_209, ap_predicate_op32_read_state2, ap_block_state2_io, out_V_TREADY_int_regslice)
    begin
        if (((ap_const_boolean_1 = ap_block_state2_io) or ((ap_predicate_op32_read_state2 = ap_const_boolean_1) and (intermediate1_empty_n = ap_const_logic_0)) or ((icmp_ln526_reg_209 = ap_const_lv1_0) and (out_V_TREADY_int_regslice = ap_const_logic_0)))) then 
    ...
    ap_ST_iter2_fsm_state3_blk_assign_proc : process(icmp_ln526_reg_209_pp0_iter1_reg, regslice_both_out_V_U_apdone_blk, ap_block_state3_io, out_V_TREADY_int_regslice)
    begin
        if (((regslice_both_out_V_U_apdone_blk = ap_const_logic_1) or (ap_const_boolean_1 = ap_block_state3_io) or ((icmp_ln526_reg_209_pp0_iter1_reg = ap_const_lv1_0) and (out_V_TREADY_int_regslice = ap_const_logic_0)))) then 
    ...
    ap_block_state2_io_assign_proc : process(icmp_ln526_reg_209, out_V_TREADY_int_regslice)
    begin
                ap_block_state2_io <= ((icmp_ln526_reg_209 = ap_const_lv1_0) and (out_V_TREADY_int_regslice = ap_const_logic_0));
    end process;


    ap_block_state2_pp0_stage0_iter1_assign_proc : process(intermediate1_empty_n, icmp_ln526_reg_209, ap_predicate_op32_read_state2, out_V_TREADY_int_regslice)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (((ap_predicate_op32_read_state2 = ap_const_boolean_1) and (intermediate1_empty_n = ap_const_logic_0)) or ((icmp_ln526_reg_209 = ap_const_lv1_0) and (out_V_TREADY_int_regslice = ap_const_logic_0)));
    end process;


    ap_block_state3_io_assign_proc : process(icmp_ln526_reg_209_pp0_iter1_reg, out_V_TREADY_int_regslice)
    begin
                ap_block_state3_io <= ((icmp_ln526_reg_209_pp0_iter1_reg = ap_const_lv1_0) and (out_V_TREADY_int_regslice = ap_const_logic_0));
    end process;


    ap_block_state3_pp0_stage0_iter2_assign_proc : process(icmp_ln526_reg_209_pp0_iter1_reg, regslice_both_out_V_U_apdone_blk, out_V_TREADY_int_regslice)
    begin
                ap_block_state3_pp0_stage0_iter2 <= ((regslice_both_out_V_U_apdone_blk = ap_const_logic_1) or ((icmp_ln526_reg_209_pp0_iter1_reg = ap_const_lv1_0) and (out_V_TREADY_int_regslice = ap_const_logic_0)));
    end process;
    ...
    ap_condition_302_assign_proc : process(ap_done_reg, intermediate1_empty_n, icmp_ln526_reg_209, ap_predicate_op32_read_state2, ap_block_state2_io, ap_CS_iter1_fsm_state2, icmp_ln526_reg_209_pp0_iter1_reg, regslice_both_out_V_U_apdone_blk, ap_block_state3_io, ap_CS_iter2_fsm_state3, out_V_TREADY_int_regslice)
    begin
    ...
    ap_done_int_assign_proc : process(ap_done_reg, icmp_ln526_reg_209_pp0_iter1_reg, regslice_both_out_V_U_apdone_blk, ap_block_state3_io, ap_CS_iter2_fsm_state3, ap_loop_exit_ready_pp0_iter2_reg, out_V_TREADY_int_regslice)
    begin
        if ((not(((regslice_both_out_V_U_apdone_blk = ap_const_logic_1) or (ap_done_reg = ap_const_logic_1) or (ap_const_boolean_1 = ap_block_state3_io) or ((icmp_ln526_reg_209_pp0_iter1_reg = ap_const_lv1_0) and (out_V_TREADY_int_regslice = ap_const_logic_0)))) and (ap_const_logic_1 = ap_CS_iter2_fsm_state3) and (ap_loop_exit_ready_pp0_iter2_reg = ap_const_logic_1))) then 
    ...
    ap_phi_mux_ei_V_3_phi_fu_80_p4_assign_proc : process(intermediate1_dout, icmp_ln526_reg_209, icmp_ln529_reg_213, icmp_ln529_reg_213_pp0_iter0_reg, ap_phi_reg_pp0_iter1_ei_V_3_reg_77, zext_ln526_fu_159_p1)
    begin
        if ((icmp_ln526_reg_209 = ap_const_lv1_0)) then
            if ((icmp_ln529_reg_213_pp0_iter0_reg = ap_const_lv1_0)) then 
                ap_phi_mux_ei_V_3_phi_fu_80_p4 <= zext_ln526_fu_159_p1;
            elsif ((icmp_ln529_reg_213 = ap_const_lv1_1)) then 
    ...
    ap_phi_reg_pp0_iter1_ei_V_3_reg_77 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";

    ap_predicate_op32_read_state2_assign_proc : process(icmp_ln526_reg_209, icmp_ln529_reg_213)
    begin
                ap_predicate_op32_read_state2 <= ((icmp_ln529_reg_213 = ap_const_lv1_1) and (icmp_ln526_reg_209 = ap_const_lv1_0));
    end process;
    ...
    begin
        if (((ap_const_logic_1 = ap_CS_iter1_fsm_state2) and (ap_loop_init_pp0_iter1_reg = ap_const_logic_1))) then 
            ap_sig_allocacmp_ei_V_load <= ap_const_lv81_0;
        else 
    ...
    eo_V_fu_164_p1 <= ap_phi_mux_ei_V_3_phi_fu_80_p4(27 - 1 downto 0);
    icmp_ln526_fu_108_p2 <= "1" when (ap_sig_allocacmp_t_3 = ap_const_lv17_15200) else "0";
    icmp_ln529_fu_120_p2 <= "1" when (ap_sig_allocacmp_o_3 = ap_const_lv32_0) else "0";
    icmp_ln529_reg_213_pp0_iter0_reg <= icmp_ln529_reg_213;
    icmp_ln540_fu_132_p2 <= "1" when (o_4_fu_126_p2 = ap_const_lv32_4) else "0";
    ...
    intermediate1_read_assign_proc : process(ap_done_reg, intermediate1_empty_n, icmp_ln526_reg_209, ap_predicate_op32_read_state2, ap_block_state2_io, ap_CS_iter1_fsm_state2, icmp_ln526_reg_209_pp0_iter1_reg, regslice_both_out_V_U_apdone_blk, ap_block_state3_io, ap_CS_iter2_fsm_state3, out_V_TREADY_int_regslice)
    begin
    ...
    out_V_TDATA_blk_n_assign_proc : process(icmp_ln526_reg_209, ap_CS_iter1_fsm_state2, icmp_ln526_reg_209_pp0_iter1_reg, ap_CS_iter2_fsm_state3, out_V_TREADY_int_regslice)
    begin
        if ((((icmp_ln526_reg_209_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_iter2_fsm_state3)) or ((icmp_ln526_reg_209 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_iter1_fsm_state2)))) then 
    ...
    out_V_TDATA_int_regslice <= std_logic_vector(IEEE.numeric_std.resize(unsigned(eo_V_fu_164_p1),32));
    ...
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_const_boolean_1 = ap_block_state2_io) or ((ap_const_logic_1 = ap_CS_iter2_fsm_state3) and ((regslice_both_out_V_U_apdone_blk = ap_const_logic_1) or (ap_const_boolean_1 = ap_block_state3_io) or ((icmp_ln526_reg_209_pp0_iter1_reg = ap_const_lv1_0) and (out_V_TREADY_int_regslice = ap_const_logic_0)))) or ((ap_predicate_op32_read_state2 = ap_const_boolean_1) and (intermediate1_empty_n = ap_const_logic_0)) or ((icmp_ln526_reg_209 = ap_const_lv1_0) and (out_V_TREADY_int_regslice = ap_const_logic_0)))) and (icmp_ln526_reg_209 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_iter1_fsm_state2))) then 
    ...
    t_4_fu_114_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_t_3) + unsigned(ap_const_lv17_1));
    zext_ln526_fu_159_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_ei_V_load),108));
end behav;
