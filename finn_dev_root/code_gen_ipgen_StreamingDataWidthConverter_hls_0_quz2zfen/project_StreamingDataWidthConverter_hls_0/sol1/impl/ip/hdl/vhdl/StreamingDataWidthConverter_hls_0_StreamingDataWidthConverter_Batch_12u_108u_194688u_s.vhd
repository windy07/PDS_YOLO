...
entity StreamingDataWidthConverter_hls_0_StreamingDataWidthConverter_Batch_12u_108u_194688u_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of StreamingDataWidthConverter_hls_0_StreamingDataWidthConverter_Batch_12u_108u_194688u_s is 
...
attribute shreg_extract : string;
    ...
    signal p_Val2_s_fu_56 : STD_LOGIC_VECTOR (95 downto 0);
    signal trunc_ln_fu_169_p3 : STD_LOGIC_VECTOR (95 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_loop_init_pp0_iter1_reg : STD_LOGIC;
    signal ap_sig_allocacmp_p_Val2_load : STD_LOGIC_VECTOR (95 downto 0);
    signal ap_sig_allocacmp_p_Val2_load_1 : STD_LOGIC_VECTOR (95 downto 0);
    ...
    signal t_fu_64 : STD_LOGIC_VECTOR (17 downto 0);
    signal t_2_fu_105_p2 : STD_LOGIC_VECTOR (17 downto 0);
    signal ap_sig_allocacmp_t_1 : STD_LOGIC_VECTOR (17 downto 0);
    signal tmp_fu_159_p4 : STD_LOGIC_VECTOR (83 downto 0);
...
begin
    ...
    regslice_both_in0_V_U : component StreamingDataWidthConverter_hls_0_regslice_both
    generic map (
        DataWidth => 16)
    port map (
        ap_clk => ap_clk,
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_109)) then
                if ((icmp_ln557_reg_204 = ap_const_lv1_0)) then 
                    ...
                    p_Val2_s_fu_56 <= ap_const_lv96_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (((ap_const_logic_1 = ap_CS_iter1_fsm_state2) and (ap_loop_init_pp0_iter1_reg = ap_const_logic_1))) then 
            ap_sig_allocacmp_p_Val2_load <= ap_const_lv96_0;
        else 
    ...
    begin
        if (((ap_const_logic_1 = ap_CS_iter1_fsm_state2) and (ap_loop_init_pp0_iter1_reg = ap_const_logic_1))) then 
            ap_sig_allocacmp_p_Val2_load_1 <= ap_const_lv96_0;
        else 
    ...
    ei_V_fu_114_p1 <= in0_V_TDATA_int_regslice(12 - 1 downto 0);
    i_1_fu_118_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_load) + unsigned(ap_const_lv32_1));
    icmp_ln557_fu_99_p2 <= "1" when (ap_sig_allocacmp_t_1 = ap_const_lv18_2F880) else "0";
    icmp_ln557_reg_204_pp0_iter0_reg <= icmp_ln557_reg_204;
    icmp_ln566_fu_124_p2 <= "1" when (i_1_fu_118_p2 = ap_const_lv32_9) else "0";
    ...
    t_2_fu_105_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_t_1) + unsigned(ap_const_lv18_1));
    tmp_fu_159_p4 <= ap_sig_allocacmp_p_Val2_load_1(95 downto 12);
